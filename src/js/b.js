!function (e) {
    ...
    if (void 0 !== e) {
        ...
        o.title = o.$name = "Editor.md", o.version = "1.5.0", o.homePage = "https://pandao.github.io/editor.md/", o.classPrefix = "editormd-", o.toolbarModes = {
        ...
        }, o.classNames = {tex: o.classPrefix + "tex"}, o.dialogZindex = 99999, o.$katex = null, o.$marked = null, o.$CodeMirror = null, o.$prettyPrint = null, o.prototype = o.fn = {
            state: {
                watching: !1,
                loaded: !1,
                preview: !1,
                ...
                return o.loadCSS(i + "codemirror/codemirror.min"), t.searchReplace && !t.readOnly && (o.loadCSS(i + "codemirror/addon/dialog/dialog"), o.loadCSS(i + "codemirror/addon/search/matchesonscrollbar")), t.codeFold && o.loadCSS(i + "codemirror/addon/fold/foldgutter"), o.loadScript(i + "codemirror/codemirror.min", function () {
                    o.$CodeMirror = CodeMirror, o.loadScript(i + "codemirror/modes.min", function () {
                        o.loadScript(i + "codemirror/addons.min", function () {
                            if (e.setCodeMirror(), "gfm" !== t.mode && "markdown" !== t.mode)return e.loadedDisplay(), !1;
                            e.setToolbar(), o.loadScript(i + "marked.min", function () {
                                o.$marked = marked, t.previewCodeHighlight ? o.loadScript(i + "prettify.min", function () {
                                        r()
                                    }) : r()
                            })
                        })
                ...
                var t = this.settings;
                return t.editorTheme = e, "default" !== e && o.loadCSS(t.path + "codemirror/theme/" + t.editorTheme), this.cm.setOption("theme", e), this
                ...
                return this.codeEditor = this.cm = o.$CodeMirror.fromTextArea(this.markdownTextarea[0], i), this.codeMirror = this.cmElement = t.children(".CodeMirror"), "" !== e.value && this.cm.setValue(e.value), this.codeMirror.css({
                    fontSize: e.fontSize,
                ...
                if (o.scrollTo(null, (s.top + s.bottom - a) / 2), i.watch) {
                    var l = this.codeMirror.find(".CodeMirror-scroll")[0], c = e(l).height(), h = l.scrollTop, d = h / l.scrollHeight;
                ...
                if (e.toolbar && r.length < 1) {
                    ...
                    t.append(n), r = this.toolbar = t.children("." + i + "toolbar")
                }
                ...
                for (var a = "function" == typeof e.toolbarIcons ? e.toolbarIcons() : "string" == typeof e.toolbarIcons ? o.toolbarModes[e.toolbarIcons] : e.toolbarIcons, s = r.find("." + this.classPrefix + "menu"), l = "", c = !1, h = 0, d = a.length; h < d; h++) {
                    ...
                    if ("||" === u) c = !0; else if ("|" === u) l += '<li class="divider" unselectable="on">|</li>'; else {
                        ...
                        void 0 !== e.toolbarCustomIcons[u] && "function" != typeof e.toolbarCustomIcons[u] ? v += e.toolbarCustomIcons[u] : (v += '<a href="javascript:;" title="' + p + '" unselectable="on">', v += '<i class="fa ' + w + '" name="' + u + '" unselectable="on">' + (f ? u.toUpperCase() : "" === w ? m : "") + "</i>", v += "</a>"), v += "</li>", l = c ? v + l : l + v
                    }
                }
                ...
                return s.bind(o.mouseOrTouch("click", "touchend"), function (o) {
                    ...
                    if ("" !== a)return t.activeIcon = r, void 0 !== l[a] ? e.proxy(l[a], t)(n) : void 0 !== i.toolbarHandlers[a] && e.proxy(i.toolbarHandlers[a], t)(n, r, s, c), "link" !== a && "reference-link" !== a && "image" !== a && "code-block" !== a && "preformatted-text" !== a && "watch" !== a && "preview" !== a && "search" !== a && "fullscreen" !== a && "info" !== a && n.focus(), !1
                }), this
            }, createDialog: function (t) {
                return e.proxy(o.createDialog, this)(t)
            }, createInfoDialog: function () {
                var e = this, t = this.editor, i = this.classPrefix, r = ['<div class="' + i + "dialog " + i + 'dialog-info" style="">', '<div class="' + i + 'dialog-container">', '<h1><i class="editormd-logo editormd-logo-lg editormd-logo-color"></i> ' + o.title + "<small>v" + o.version + "</small></h1>", "<p>" + this.lang.description + "</p>", '<p style="margin: 10px 0 20px 0;"><a href="' + o.homePage + '" target="_blank">' + o.homePage + ' <i class="fa fa-external-link"></i></a></p>', '<p style="font-size: 0.85em;">Copyright &copy; 2015 <a href="https://github.com/pandao" target="_blank" class="hover-link">Pandao</a>, The <a href="https://github.com/pandao/editor.md/blob/master/LICENSE" target="_blank" class="hover-link">MIT</a> License.</p>', "</div>", '<a href="javascript:;" class="fa fa-close ' + i + 'dialog-close"></a>', "</div>"].join("\n");
                t.append(r);
                var n = this.infoDialog = t.children("." + i + "dialog-info");
                return n.find("." + i + "dialog-close").bind(o.mouseOrTouch("click", "touchend"), function () {
                    e.hideInfoDialog()
                }), n.css("border", o.isIE8 ? "1px solid #ddd" : "").css("z-index", o.dialogZindex).show(), this.infoDialogPosition(), this
                ...
                }).show(), r.css("z-index", o.dialogZindex).show(), this.infoDialogPosition(), this
            }, hideInfoDialog: function () {
                return e("html,body").css("overflow-x", ""), this.infoDialog.hide(), this.mask.hide(), this.lockScreen(!1), this
            }, lockScreen: function (e) {
                return o.lockScreen(e), this.resize(), this
            }, recreate: function () {
                ...
                return null === t ? this : (this.previewContainer.find("." + o.classNames.tex).each(function () {
                        var t = e(this);
                        o.$katex.render(t.text(), t[0]), t.find(".katex").css("font-size", "1.6em")
                    }), this)
            }, flowChartAndSequenceDiagramRender: function () {
                var t = this.settings, r = this.previewContainer;
                if (o.isIE8)return this;
                if (t.flowChart) {
                    if (null === i)return this;
                    r.find(".flowchart").flowChart()
                }
                t.sequenceDiagram && r.find(".sequence-diagram").sequenceDiagram({theme: "simple"});
                ...
                return d = d || 0, 0 === l ? n.scrollTop(0) : l + s >= a[0].scrollHeight - 16 ? n.scrollTop(n[0].scrollHeight) : n.scrollTop((n[0].scrollHeight + h + d) * c), this
            }, registerKeyMaps: function (t) {
                var i = this, r = this.cm, n = this.settings, a = o.toolbarHandlers, s = n.disabledKeyMaps;
                if (t = t || null) {
                    for (var l in t)if (e.inArray(l, s) < 0) {
                        t[l], r.addKeyMap(t)
                    }
                } else {
                    for (var c in o.keyMaps) {
                        var h = o.keyMaps[c], d = "string" == typeof h ? e.proxy(a[h], i) : e.proxy(h, i);
                    ...
                    e(window).keydown(function (t) {
                        if (e.inArray({120: "F9", 121: "F10", 122: "F11"}[t.keyCode], s) < 0)switch (t.keyCode) {
                            case 120:
                                return e.proxy(a.watch, i)(), !1;
                            case 121:
                                return e.proxy(a.preview, i)(), !1;
                            case 122:
                                return e.proxy(a.fullscreen, i)(), !1
                        }
                    })
                }
                return this
            }, bindScrollEvent: function () {
                var t = this, i = this.preview, r = this.settings, n = this.codeMirror, a = o.mouseOrTouch;
                ...
                var s = function () {
                    n.find(".CodeMirror-scroll").bind(a("scroll", "touchmove"), function (o) {
                        ...
                        c = c || 0, 0 === a ? i.scrollTop(0) : a + n >= e(this)[0].scrollHeight - 16 ? i.scrollTop(i[0].scrollHeight) : i.scrollTop((i[0].scrollHeight + l + c) * s), e.proxy(r.onscroll, t)(o)
                    })
                }, l = function () {
                    ...
                    i.bind(a("scroll", "touchmove"), function (i) {
                        ...
                        0 === a ? l.scrollTop(0) : a + o >= e(this)[0].scrollHeight ? l.scrollTop(l[0].scrollHeight) : l.scrollTop(l[0].scrollHeight * s), e.proxy(r.onpreviewscroll, t)(i)
                    })
                }, h = function () {
                ...
                var e = this, i = this.cm, o = this.settings;
                return o.syncScrolling ? (i.on("change", function (i, r) {
                        o.watch && e.previewContainer.css("padding", o.autoHeight ? "20px 20px 50px 40px" : "20px"), t = setTimeout(function () {
                ...
                var r = this, n = this.state, a = this.settings;
                ...
                var h = o.$marked, d = this.markdownToC = [], u = this.markedRendererOptions = {
                    toc: a.toc,
                    tocm: a.tocm,
                ...
                h.setOptions(f);
                var g = o.$marked(l, f);
                if (g = o.filterHTMLTags(g, a.htmlDecode), this.markdownTextarea.text(l), s.save(), a.saveHTMLToTextarea && this.htmlTextarea.text(g), a.watch || !a.watch && n.preview) {
                    ...
                    a.tex && (!o.kaTeXLoaded && a.autoLoadModules ? o.loadKaTeX(function () {
                            o.$katex = katex, o.kaTeXLoaded = !0, r.katexRender()
                        }) : (o.$katex = katex, this.katexRender())), (a.flowChart || a.sequenceDiagram) && (i = setTimeout(function () {
                        clearTimeout(i), r.flowChartAndSequenceDiagramRender(), i = null
                ...
                return this.codeMirror.css("border-right", "1px solid #ddd").width(this.editor.width() / 2), t = 0, this.save().resize(), o.onwatch || (o.onwatch = i || function () {
                ...
                var t = this, i = this.editor, r = this.preview, n = this.toolbar, a = this.settings, s = this.codeMirror, l = this.previewContainer;
                ...
                "none" === s.css("display") ? (this.state.preview = !0, this.state.fullscreen && r.css("background", "#fff"), i.find("." + this.classPrefix + "preview-close-btn").show().bind(o.mouseOrTouch("click", "touchend"), function () {
                        t.previewed()
                ...
                var t = this.editor, i = this.preview, r = this.toolbar, n = this.settings, a = this.previewContainer, s = t.find("." + this.classPrefix + "preview-close-btn");
                return this.state.preview = !1, this.codeMirror.show(), n.toolbar && r.show(), i[n.watch ? "show" : "hide"](), s.hide().unbind(o.mouseOrTouch("click", "touchend")), a.removeClass(this.classPrefix + "preview-active"), n.watch && a.css("padding", "20px"), i.css({
                    background: null,
                    position: "absolute",
                    width: t.width() / 2,
                ...
                return i = this.settings.pluginPath + i, "function" == typeof define ? void 0 === this[t] ? (alert("Error: " + t + " plugin is not found, you are not load this plugin."), this) : (this[t](n), this) : (e.inArray(i, o.loadFiles.plugin) < 0 ? o.loadPlugin(i, function () {
                            o.loadPlugins[t] = r[t], r[t](n)
                        }) : e.proxy(o.loadPlugins[t], this)(n), this)
            }, search: function (e) {
                var t = this.settings;
        ...
        }, o.fn.init.prototype = o.fn, o.dialogLockScreen = function () {
            ...
            undo: function () {
                ...
                e.replaceSelection(o.firstUpperCase(t)), e.setSelections(i)
            }, ucwords: function () {
                var e = this.cm, t = e.getSelection(), i = e.listSelections();
                e.replaceSelection(o.wordsFirstUpperCase(t)), e.setSelections(i)
            }, uppercase: function () {
                var e = this.cm, t = e.getSelection(), i = e.listSelections();
                ...
                var e = this.cm, t = (e.getSelection(), new Date, this.settings.lang.name), i = o.dateFormat() + " " + o.dateFormat("zh-cn" === t || "zh-tw" === t ? "cn-week-day" : "week-day");
            ...
            "Ctrl-E": function () {
                var e = this.cm, t = e.getCursor(), i = e.getSelection();
                this.settings.emoji ? (e.replaceSelection(":" + i + ":"), "" === i && e.setCursor(t.line, t.ch + 1)) : alert("Error: settings.emoji == false")
            },
            ...
            "Shift-Ctrl-A": function () {
                var e = this.cm, t = e.getCursor(), i = e.getSelection();
                this.settings.atLink ? (e.replaceSelection("@" + i), "" === i && e.setCursor(t.line, t.ch + 1)) : alert("Error: settings.atLink == false")
            },
            "Shift-Ctrl-C": "code",
            "Shift-Ctrl-Q": "quote",
            "Shift-Ctrl-S": "del",
        ...
        return o.firstUpperCase = o.ucfirst = n, o.urls = {atLinkBase: "https://github.com/"}, o.regexs = {
            atLink: /@(\w+)/g,
            email: /(\w+)@(\w+)\.(\w+)\.?(\w+)?/g,
            ...
            ext: ".png"
        }, o.twemoji = {path: "http://twemoji.maxcdn.com/36x36/", ext: ".png"}, o.markedRenderer = function (t, i) {
            var n = e.extend({
                toc: !0,
                tocm: !1,
                tocStartLevel: 1,
            ...
            return s.emoji = function (e) {
                ...
                for (var i = 0, r = t.length; i < r; i++)":+1:" === t[i] && (t[i] = ":\\+1:"), e = e.replace(new RegExp(t[i]), function (e, t) {
                    var i = e.match(g), r = e.replace(/:/g, "");
                    if (i)for (var n = 0, a = i.length; n < a; n++) {
                        var s = i[n].replace(/:/g, "");
                        return '<i class="fa ' + s + ' fa-emoji" title="' + s.replace("fa-", "") + '"></i>'
                    } else {
                        var l = e.match(p), c = e.match(f);
                        if (l)for (var h = 0, d = l.length; h < d; h++) {
                            ...
                            if (!c) {
                                var m = "+1" === r ? "plus1" : r;
                                return m = "moon" === (m = "black_large_square" === m ? "black_square" : m) ? "waxing_gibbous_moon" : m, '<img src="' + o.emoji.path + m + o.emoji.ext + '" class="emoji" title="&#58;' + r + '&#58;" alt="&#58;' + r + '&#58;" />'
                            }
                ...
                return c.test(t) ? (n.atLink && (t = (t = t.replace(d, function (e, t, i, o) {
                    ...
                    }).replace(/_#_&#64;_#_/g, "@")), n.emailLink && (t = t.replace(u, function (t, i, o, r, n) {
                ...
                var h = {
                    text: e = r(e),
                    level: i,
                    slug: e.toLowerCase().replace(/[^\w]+/g, "-")
                }, d = /^[\u4e00-\u9fa5]+$/.test(e) ? escape(e).replace(/\%/g, "") : e.toLowerCase().replace(/[^\w]+/g, "-");
                t.push(h);
                var u = "<h" + i + ' id="h' + i + "-" + this.options.headerPrefix + d + '">';
                return u += '<a name="' + e + '" class="reference-link"></a>', u += '<span class="header-link octicon octicon-link"></span>', u += a ? this.atLink(this.emoji(n)) : this.atLink(this.emoji(e)), u += "</h" + i + ">"
            }, s.pageBreak = function (e) {
                return m.test(e) && n.pageBreak && (e = '<hr style="page-break-after:always;" class="page-break editormd-page-break" />'), e
            }, s.paragraph = function (e) {
                var t = /\$\$(.*)\$\$/g.test(e), i = /^\$\$(.*)\$\$$/.test(e), r = i ? ' class="' + o.classNames.tex + '"' : "", a = n.tocm ? /^(\[TOC\]|\[TOCM\])$/.test(e) : /^\[TOC\]$/.test(e), s = /^\[TOCM\]$/.test(e), l = '<div class="markdown-toc editormd-markdown-toc">' + (e = !i && t ? e.replace(/(\$\$([^\$]*)\$\$)+/g, function (e, t) {
            ...
            for (var s = 0, l = e.length; s < l; s++) {
                ...
                h < o || (r += h > n ? "" : h < n ? new Array(n - h + 2).join("</ul></li>") : "</ul></li>", r += '<li><a class="toc-level-' + h + '" href="#' + c + '" level="' + h + '">' + c + "</a><ul>", n = h)
            }
            ...
            o.$marked = marked;
            var r = e("#" + t), n = r.settings = e.extend(!0, {
                gfm: !0,
                toc: !0,
                tocm: !1,
                tocStartLevel: 1,
            ...
            var s = "" === n.markdown ? a.val() : n.markdown, l = [], c = {
                toc: n.toc,
                tocm: n.tocm,
            ...
            r.type = "text/css", r.rel = "stylesheet", r.onload = r.onreadystatechange = function () {
                o.loadFiles.css.push(e), t()
            }, r.href = e + ".css", "head" === i ? document.getElementsByTagName("head")[0].appendChild(r) : document.body.appendChild(r)
        }, o.isIE = "Microsoft Internet Explorer" == navigator.appName, o.isIE8 = o.isIE && "8." == navigator.appVersion.match(/8./i), o.loadScript = function (e, t, i) {
            i = i || "head", t = t || function () {
                };
            var r = null;
            (r = document.createElement("script")).id = e.replace(/[\./]+/g, "-"), r.type = "text/javascript", r.src = e + ".js", o.isIE8 ? r.onreadystatechange = function () {
                    r.readyState && ("loaded" !== r.readyState && "complete" !== r.readyState || (r.onreadystatechange = null, o.loadFiles.js.push(e), t()))
                } : r.onload = function () {
                    o.loadFiles.js.push(e), t()
                }, "head" === i ? document.getElementsByTagName("head")[0].appendChild(r) : document.body.appendChild(r)
        }, o.katexURL = {
            css: "//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min",
            js: "//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min"
        }, o.kaTeXLoaded = !1, o.loadKaTeX = function (e) {
            ...
            h.lockScreen = function (o) {
                ...
                return t.mask && r.find("." + n + "mask").css(t.maskStyle).css("z-index", o.dialogZindex - 1).show(), h
            }, h.hideMask = function () {
                return t.mask && r.find("." + n + "mask").hide(), h
            }, h.loading = function (e) {
                return h.find("." + n + "dialog-mask")[e ? "show" : "hide"](), h
            ...
            if ("" !== t.title && t.drag) {
                ...
                t.mask || v.bind(l("click", "touchend"), function () {
                    o.dialogZindex += 2, h.css("z-index", o.dialogZindex)
